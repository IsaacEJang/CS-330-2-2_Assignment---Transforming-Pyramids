...
{
	// for wireframe meshes view, uncomment following line
	...
	// translated pyramid to stack below 2nd pyramid
	...
	//ROTATED THE SECOND PYRAMID UPSIDE DOWN
	// set the XYZ rotation for the mesh
	XrotationDegrees = 180.0f;
	YrotationDegrees = 0.0f;
	ZrotationDegrees = 0.0f;

	//STACKED THE PYRAMIDS AND SHIFTED THE Y CORDS TO 1
	// set the XYZ position for the mesh
	...
	// Set the shader color to white for the solid mesh
